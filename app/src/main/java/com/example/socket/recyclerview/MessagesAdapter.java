...
import com.example.socket.utilities.JsonUtils;
...
public class MessagesAdapter<U, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        switch (type) {
            case 0:
                return new RightViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_message_right, viewGroup, false));
            case 1:
                return new LeftViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_message_left, viewGroup, false));
        }
        return null;
    }
