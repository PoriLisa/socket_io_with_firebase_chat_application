...
import com.example.socket.recyclerview.FriendsAdapter;
...
public class FriendsFragment extends Fragment implements SearchView.OnQueryTextListener, LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    public static final String[] MAIN_PROJECTION = {
           DatabaseContract.Friends._ID,
            DatabaseContract.Friends.COLUMN_UID,
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        String whereClause = DatabaseContract.Friends.COLUMN_TYPE;
        switch (id) {
            case ID_LOADER_PENDING:
                Uri pendingUri = DatabaseContract.Friends.CONTENT_URI;
            ...
            case ID_LOADER_FRIENDS:
                Uri friendsUri = DatabaseContract.Friends.CONTENT_URI;
                return new CursorLoader(getActivity(),
                        friendsUri,
                        MAIN_PROJECTION,
                        whereClause  + " = 'friend'",
    ...
    private Emitter.Listener onRefreshed = new Emitter.Listener() {
        ...
        public void call(final Object... args) {
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                   // getLoaderManager().restartLoader(ID_LOADER_PENDING, null, this);
