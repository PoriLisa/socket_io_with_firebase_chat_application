...
import com.example.socket.activities.MainTabbedActivity;
import com.example.socket.activities.MessageActivity;
import com.example.socket.data.DatabaseContract;
import com.example.socket.utilities.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        try {
            ...
            conversationValues.put(DatabaseContract.Messages.COLUMN_CONVERSATION_ID, conversationId);
    ...
    private void handleNewConversation(JSONObject json) {
        try {
                ...
                ContentValues conversationValues = new ContentValues();
                conversationValues.put(DatabaseContract.Conversations.COLUMN_UID, conversationId);
    ...
    private void handleFriendRequest(JSONObject json) {
        try {
            ...
            ContentValues conversationValues = new ContentValues();
            conversationValues.put(DatabaseContract.Friends.COLUMN_UID, by);
            conversationValues.put(DatabaseContract.Friends.COLUMN_NAME, name);
            conversationValues.put(DatabaseContract.Friends.COLUMN_TYPE, "pending");
