...
public class RegisterActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Objects.requireNonNull(AppSocketListener.getInstance()).addOnHandler(SocketEventConstants.registerResponse, AppContext.getEmitterListeners().onRegister);
    ...
    public Emitter.Listener startActivity = args -> {
        appSocketListeners.getInstance().off(SocketEventConstants.registerResponse);
